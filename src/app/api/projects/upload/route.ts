...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[Projects][UPLOAD] Subiendo imagen: ${file.name} (${(file.size / (1024 * 1024)).toFixed(2)} MB)`);

    // Subir archivo usando el servicio de almacenamiento (S3/Spaces)
    ...
    console.log(`[Projects][UPLOAD] Imagen subida: ${uploadResult.url}`);
