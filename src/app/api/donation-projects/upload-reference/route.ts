...
export async function POST(request: NextRequest) {
  try {
    ...
    const upload = await storageService.uploadFile(buffer, file.name, {
      ...
      prefix: 'donation-projects-reference/' // Prefijo específico para imágenes de referencia
    });
    ...
    console.error('Error al subir imagen de referencia de proyecto de donación:', error);
