        ...
        <main className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex justify-center">
          <div className="max-w-2xl text-white text-center">
            ...
            <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold leading-tight text-white">
              NUESTRAS INICIATIVAS DE IMPACTO
              </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-200">
              Descubre nuestro trabajo integral que combina programas estratégicos, proyectos específicos y metodologías innovadoras para crear impacto social sostenible en las comunidades más vulnerables.
            </p>
            <div className="mt-8">
